...
public class ReviewViewHolder extends RecyclerView.ViewHolder {
   ...
   View mView;
    ...
    public ReviewViewHolder(@NonNull android.view.View itemView) {
        super(itemView);
    ...
    public void setDetails (Context context, String review_name, String review_text, int review_star_rating) {
        ...
        RatingBar mReviewStarRating = mView.findViewById(R.id.review_star_rating);

        mReviewName.setText(review_name);
        mReviewText.setText(review_text);
        mReviewStarRating.setNumStars(review_star_rating);
    }
}
